...
class Config:
    ...
    # --- Database Settings ---
    DB_NAME: str = "***REMOVED***"
    BACKUP_DIR: str = "***REMOVED***"
    SCHEMA_VERSION: str = "1.0.1"

    # --- Input Data Paths ---
    CRICSHEET_JSON_DIR: str = "***REMOVED***"
    REGISTRY_CSV_PATH: str = "***REMOVED***"
    TEAMS_CSV_PATH: str = "***REMOVED***"
    VENUES_CSV_PATH: str = "***REMOVED***"
    VENUE_ALIASES_CSV_PATH: str = "***REMOVED***"
    PLAYERS_CSV_PATH: str = "***REMOVED***"
    OFFICIALS_CSV_PATH: str = "***REMOVED***"
